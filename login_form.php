    ...
    <div class="row px-3">
        <div class="col-lg-10 col-xl-9 card flex-row mx-auto px-0">
            ...
            <div class="card-body">
                ...
                <form class="form-box px-3" action="server.php" method="POST">
                    ...
                    <div class="form-input">
                        <button type="button" onclick="signInWithGoogle()" class="btn btn-block btn-outline-primary">
...
<script>
    function signInWithGoogle() {
        // Redirect to Google's authentication page for login
